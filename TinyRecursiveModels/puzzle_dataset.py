    ...
    def _iter_test(self):
        for set_i, (set_name, dataset) in enumerate(self._data.items()):  # type: ignore
            ...
            while start_index < total_examples:
                ...
                # Optimized: Vectorized mapping of sample index to puzzle index
                range_indices = np.arange(local_start, local_end)
                puzzle_indices = np.searchsorted(dataset["puzzle_indices"], range_indices, side="right") - 1
